...
(function (global, factory) {
  ...
  (global = global || self, global.NewCustom = factory(global.Popper));
  ...
  var defaultPreventedPreservedOnDispatch = function () {
    var e = new CustomEvent('NewCustom', {
      cancelable: true
    });
    var element = document.createElement('div');
    element.addEventListener('NewCustom', function () {
      return null;
    });
    e.preventDefault();
  ...
  function NewCustomHandler(element, fn) {
  ...
  function NewCustomDelegationHandler(element, selector, fn) {
    return function handler(event) {
  ...
  function addHandler(element, originalTypeEvent, handler, delegationFn, oneOff) {
    ...
    var fn = delegation ? NewCustomDelegationHandler(element, handler, delegationFn) : NewCustomHandler(element, handler);
    ...
    _proto.show = function show() {
      ...
      if (!this._inNavbar) {
        if (typeof Popper === 'undefined') {
          throw new TypeError('NewCustom\'s dropdowns require Popper.js (https://popper.js.org)');
        }
  ...
  var Tooltip = /*#__PURE__*/function () {
    function Tooltip(element, config) {
      if (typeof Popper === 'undefined') {
        throw new TypeError('NewCustom\'s tooltips require Popper.js (https://popper.js.org)');
      } // private
